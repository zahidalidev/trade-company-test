        ...
        {activeTab === "companies" ? (
          <>
            <Flex className="image-flex ">
              ...
              <Flex className="relative-position zindex2">
                <Image
                  src="/icons/pic3.svg"
                  alt="pic 3"
                  width={100}
              ...
              <Flex className="relative-position zindex3">
                <Image
                  src="/icons/pic1.svg"
                  alt="pic 1"
                  width={100}
          ...
          <Flex vertical="vertical" align="center">
            <Text className="secondaryTitle marginTop18 textAlignCenter color24292E">
              Providing best quality supply chains and e-commerce anywhere &
              anytime. Trade shows & trade programs, SaaS technologies and
              marketing.
            </Text>
          </Flex>
        )}
